...
module.exports = {
        ...
        bookTrips: async (_, { launchIds }, { dataSources }) => {
            ...
            return {
                ...
                message: results.length === launchIds.length 
                                ...
                                : `the following launches could not be booked: ${ launchesIds.filter(id => !results.includes(id)) }`,
                launches
            }
        },
    ...
    Query: {
        launches: async (_, { pageSize = 20, after }, { dataSources }) => {
            ...
            return {
                ...
                hasMore: launches.length ? launches[launches.length -1].cursor !== allLaunches[allLaunches.length - 1].cursor
                                         : false,
            }
        },
    ...
    Mission: {
        ...
        missionPatch: (mission, { size } = { size: 'LARGE' }) => {
            return size === 'SMALL' ? mission.missionPatchSmall
                                    : mission.missionPathLarge;
        }
    },
    Launch: {
